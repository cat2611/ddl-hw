# Домашнее задание к занятию "`Работа с данными (DDL/DML)`" - `Сергеева Екатерина`
...
#### Ответ  
3.1  
Так как в задании 1.4 права нахначались глобально(*.*) то и отзывать их надо также:  
```
...
SHOW GRANTS FOR 'sys_temp'@'%';  
```
![Task3-2](https://github.com/cat2611/ddl-hw/blob/main/img/31.PNG)    
